...
namespace HelloGame
{
    public class Game1 : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (_ballPosition.X < 0 || _ballPosition.X > _graphics.GraphicsDevice.Viewport.Width - 64)
                _ballVelocity.X *= -1;
            if (_ballPosition.Y < 0 || _ballPosition.Y > _graphics.GraphicsDevice.Viewport.Height - 64)
                _ballVelocity.Y *= -1;
